...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8'>
       ...
       <div className='my-8'>
         <a href='https://drive.google.com/file/d/10ZW7adrCBDdVxmk-c2LLPWPEdH8BvNDN/view?usp=drivesdk
         ' className='px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white '>Resume</a>
