...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8'>
       ...
       <div className='my-8'>
         <a href='Highlighted expertise in integrating backend services, enhancing functionality and improving user satisfaction by 40%' className='px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white '>Resume</a>
